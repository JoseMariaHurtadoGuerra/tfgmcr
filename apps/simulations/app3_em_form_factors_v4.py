...
q2_max = st.sidebar.slider(r"$|Q^2|_{\max}$ (GeV$^2$)", 0.10, 1.00, 1.00, 0.05)
...
- **$|Q^2|_{\max}$** se mantiene en la región baja para que la exploración siga centrada en el rango donde Galster resulta más instructivo.
""")
        st.markdown(r"""
